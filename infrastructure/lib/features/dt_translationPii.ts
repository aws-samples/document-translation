...
import { dt_callback } from "../components/dt_callback";
	...
	constructor(scope: Construct, id: string, props: props) {
		...
		NagSuppressions.addResourceSuppressions(
			...
			[
				...
				{
					id: "AwsSolutions-IAM5",
					reason: "Restricted to Lamdba ARN",
					appliesTo: [
						"Resource::<basetranslatereplacePlusWithSpaceLambda88EF22E1.Arn>:*",
					],
				},
				{
					id: "AwsSolutions-IAM5",
					reason: "Restricted to Lamdba ARN",
					appliesTo: [
						"Resource::<basetranslatelambdaParseTerminologies791D1EF3.Arn>:*",
					],
				},
			],
			true
