	...
	constructor(scope: Construct, id: string, props: props) {
			...
			"permitSfnSendSuccess",
			{
				...
				statements: [
					new iam.PolicyStatement({
						...
						resources: [
							"arn:aws:bedrock:*::foundation-model/stability.stable-diffusion-*", // Foundational Models
						],
					}),
				],
			},
			...
			[
				{
					...
					appliesTo: [
						"Resource::arn:aws:bedrock:*::foundation-model/stability.stable-diffusion-*",
					],
				},
			],
			true,
		...
		const invokeBedrock = new tasks.LambdaInvoke(this, "invokeBedrock", {
			...
			payload: sfn.TaskInput.fromObject({
				...
				PathToResult: "Body.artifacts[0].base64",
