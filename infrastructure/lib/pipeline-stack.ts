...
export class pipelineStack extends cdk.Stack {
	constructor(scope: Construct, id: string, props?: cdk.StackProps) {
		...
		const sourceGitRepo: string =
			process.env.sourceGitRepo !== undefined
				? process.env.sourceGitRepo
				: "";
		...
		switch (sourceGitService) {
			...
			default:
				...
				const codeCommitRepo = codecommit.Repository.fromRepositoryName(this, 'codeCommitRepo', sourceGitRepo);
